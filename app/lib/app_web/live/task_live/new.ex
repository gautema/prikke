defmodule PrikkeWeb.TaskLive.New do
  ...
  def handle_event("validate", %{"task" => task_params} = params, socket) do
    ...
    {task_params, failure_mode, recovery_mode} =
      task_params |> Map.put("schedule_type", schedule_type) |> cast_notification_overrides(socket)
  ...
  def handle_event("save", %{"task" => task_params}, socket) do
    {task_params, _, _} = cast_notification_overrides(task_params, socket)
