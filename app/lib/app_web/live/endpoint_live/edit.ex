  ...
  def mount(%{"id" => id}, session, socket) do
    ...
    if org do
      ...
      {:ok,
       ...
       |> assign(:failure_notification_mode, notification_mode(endpoint.on_failure_url))
       |> assign(:recovery_notification_mode, notification_mode(endpoint.on_recovery_url))
